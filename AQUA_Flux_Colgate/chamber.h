...
#if USE_ACTUATOR
// actuator is the Servo instance declared in AQUA_Flux_Colgate.ino
...
void ChamberActuator::_setState(ActuatorState s)
{
    ...
    // OPENING and CLOSING use print() (no newline) so the dot-per-second output
    // from loop() follows on the same line. OPEN and CLOSED use println() to end it.
    switch (s)
    {
    case OPENING: LOG_STREAM.print(F("Opening Chamber"));  break;
    case OPEN:    LOG_STREAM.println(F("Chamber is OPEN")); break;
    case CLOSING: LOG_STREAM.print(F("Closing Chamber"));  break;
    case CLOSED:  LOG_STREAM.println(F("Chamber is CLOSED")); break;
    default: break;
    }
    ...
    switch (s)
    {
    case OPEN:   logfile.println(F("Chamber is OPEN"));   break;
    case CLOSED: logfile.println(F("Chamber is CLOSED")); break;
    default: break;
    }
#endif
}
